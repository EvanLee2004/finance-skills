...
> 一句话定位：金蝶星辰各账套科目余额 + 部门核算项目 + 利润表本月金额 + 职工薪酬台账 → 斯佳「损益表 + 利润表」Excel；山东/四川/济南吃月更 Excel。公式自写核对，禁止改数凑平。
...
| `config/残差归集.json` | 折旧/摊销→运保；税金及附加/财务费用→财务中心；540103→项目总监 |
